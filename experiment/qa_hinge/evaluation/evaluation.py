...
class QAEvaluationHinge(BasicQAEvaluation):
    def __init__(self, config, config_global, logger):
        super(QAEvaluationHinge, self).__init__(config, config_global, logger)
    ...
    def score(self, qa_pairs, model, data, sess):
        ...
        scores, = sess.run([model.predict], feed_dict={
            ...
            model.input_answer_good: test_answers,
