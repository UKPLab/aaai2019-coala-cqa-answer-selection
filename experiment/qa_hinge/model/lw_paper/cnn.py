...
from experiment.qa_hinge.model import QAModel, bias_variable, weight_variable
from experiment.qa_hinge.model.lw_paper.helper.pooling_helper import maxpool_tanh
